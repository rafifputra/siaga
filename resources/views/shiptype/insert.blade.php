						...
						<div class="inner">
							<ol class="breadcrumb" style="padding-top: 10px;">
								<li class="breadcrumb-item" style="padding-bottom: 10px;">
									<a href="/shiptype" class="router-link-exact-active active">Ship Type</a>
								</li>
								<li class="breadcrumb-item" style="padding-bottom: 10px;">
							...
							<div class="col-md-12">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<div class="row">
											<form role="form" action="{{url('shiptypeAdd')}}" method="POST">
												{{csrf_field()}}
												<div class="col-md-6">
													<div class="form-group{{$errors->has('code') ? ' has-error' : ''}}">
														<label>CODE SHIPTYPE<a class="simbol" style="margin-left: 5px;">*</a></label>
