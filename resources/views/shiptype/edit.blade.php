						...
						<div class="inner">
							<ol class="breadcrumb" style="padding-top: 20px;">
								<li class="breadcrumb-item" style="padding-bottom: 10px;">
									<a href="/shipyard" class="router-link-exact-active active">Ship Type</a>
								</li>
								<li class="breadcrumb-item" style="padding-bottom: 10px;">
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<div class="row">
											...
											<form role="form" action="{{url('shiptypeUpdate')}}" method="POST">
												{{csrf_field()}}
												<input type="hidden" name="id" value="{{$shiptype->id}}">
												<div class="col-md-6">
													<div class="form-group {{$errors->has('code') ? 'has-error' : '' }}">
														<label>CODE SHIPTYPE
															<span class="simbol" style="margin-left: 5px;">*</span>
														</label>
														<input type="text" name="code" class="form-control" value="{{$shiptype->code}}">
														@if($errors->has('code'))
												...
												<div class="col-md-6">
													<div class="form-group {{$errors->has('name') ? 'has-error' : '' }}">
														...
														<input type="text" name="name" class="form-control" value="{{$shiptype->name}}">
														@if($errors->has('name'))
            												<span class="help-block">Please fill out this field</span>
        												@endif
													</div>
