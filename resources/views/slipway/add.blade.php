						...
						<div class="inner">
							<ol class="breadcrumb" style="padding-top: 10px;">
								<li class="breadcrumb-item" style="padding-bottom: 10px;">
									<a href="/slipway" class="router-link-exact-active active">
									Slipway</a>
								</li>
								<li class="breadcrumb-item" style="padding-bottom: 10px;">
							...
							<div class="col-md-12">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<div class="row">
											<form role="form" action="{{url('slipwayAdd')}}" method="POST">
												{{csrf_field()}}
												<div class="col-md-6">
												...
												<div class="col-md-6">
													<div class="form-group{{$errors->has('length') ? ' has-error' : '' }}">
														...
														<input type="number" name="length" class="form-control" placeholder="0 M">
												...
												<div class="col-md-6">
													<div class="form-group{{$errors->has('width') ? ' has-error' : '' }}">
														...
														<input type="number" name="width" class="form-control" placeholder="0 M">
														@if($errors->has('width'))
            												<span class="help-block">Please fill out this field</span>
        												@endif
													</div>
												...
												<div class="col-md-6">
													<div class="form-group{{$errors->has('depth') ? ' has-error' : '' }}">
														...
														<input type="number" name="depth" class="form-control" placeholder="0 M">
														@if($errors->has('depth'))
            												<span class="help-block">Please fill out this field</span>
        												@endif
													</div>
