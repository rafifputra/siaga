						...
						<div class="inner">
							<ol class="breadcrumb" style="padding-top: 10px;">
								<li class="breadcrumb-item" style="padding-bottom: 10px;">
									<a href="/shipyard" class="router-link-exact-active active">
									Ships</a>
								</li>
								<li class="breadcrumb-item" style="padding-bottom: 10px;">
							...
							<div class="col-md-12">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<div class="row">
											<form role="form" action="{{url('shipyardAdd')}}" method="POST">
												{{csrf_field()}}
												<div class="col-md-6">
												...
												<div class="col-md-6">
													<div class="form-group{{$errors->has('loa') ? ' has-error' : ''}}">
														...
														<input type="number" name="loa" class="form-control" placeholder="0 M">
														@if($errors->has('loa'))
															<span class="help-block">Please fill out this field</span>
														@endif
													</div>
												...
												<div class="col-md-6">
													<div class="form-group{{$errors->has('deadweight') ? ' has-error' : ''}}">
														...
														<input type="number" name="deadweight" class="form-control" placeholder="0 KG">
												...
												<div class="col-md-6">
													<div class="form-group{{$errors->has('cb') ? ' has-error' : ''}}">
														...
														<input type="number" name="cb" class="form-control" placeholder="0 KG">
														@if($errors->has('cb'))
															<span class="help-block">Please fill out this field</span>
														@endif
													</div>
												...
												<div class="col-md-6">
													<div class="form-group{{$errors->has('type') ? ' has-error' : ''}}">
														...
														<select class="form-control" id="selecttypeship" name="type"></select>
														@if($errors->has('type'))
															<span class="help-block">Please fill out this field</span>
														@endif
													</div>
												...
												<div class="col-md-12">
													...
													<button class="btn btn-delete" type="button" value="cancel" style="margin-right: 10px; 
														float: right;" onclick="history.back(-1)"> 
														Cancel
													</button>
												</div>
											</form>
